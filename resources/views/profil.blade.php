                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" value="{{ $nameValue }}"
                               class="w-full bg-gray-50 dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-2xl px-6 py-4 text-sm font-bold outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div class="space-y-2">
                        ...
                        <input type="email" value="{{ $emailValue }}" disabled
                               class="w-full bg-gray-100 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-2xl px-6 py-4 text-sm font-bold text-slate-400 cursor-not-allowed">
                    </div>
                    <div class="space-y-2">
            ...
            <div class="p-10 bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-[3rem] shadow-sm">
                ...
                @if($identityPath)
                    <div class="mb-8 p-6 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-500/20 rounded-3xl flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] font-black uppercase tracking-widest text-emerald-500 opacity-60">
                ...
                <div class="p-12 border-2 border-dashed border-gray-100 dark:border-slate-800 rounded-3xl text-center bg-gray-50/50 dark:bg-slate-900/50 hover:border-blue-500 transition-all group relative">
                    ...
                    <label for="identity_file" class="cursor-pointer">
                        ...
                        <span id="file-name-label" class="text-sm font-bold text-slate-900 dark:text-white block">
